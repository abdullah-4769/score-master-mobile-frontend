// lib/components/scoring_breakdown_container.dart
...
class ScoringBreakdownContainer extends StatelessWidget {
  ...
  const ScoringBreakdownContainer({
    super.key,
  ...
  Widget build(BuildContext context) {
    print('Building ScoringBreakdownContainer');
    print('Charity: $charity');
    print('Strategic Thinking: $strategicThinking');
