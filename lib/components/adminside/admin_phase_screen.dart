...
class AdminPhaseScreen extends StatelessWidget {
        ...
        SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Observe the phases list and rebuild when it changes
                    Obx(() => Column(
                      children: [
                        // Existing hardcoded phases - you can replace these with dynamic data
              ...
              // Updated Add Phases Button with controller integration
              Center(
                child: GestureDetector(
                  onTap: () {
                    // Navigate to Add Phase screen or show bottom sheet
                    _showAddPhaseBottomSheet(context, screenWidth, screenHeight);
                  },
                  child: LoginButton(
                    fontSize: 20,
                    text: "add_phases".tr,
  ...
  // Method to show Add Phase Bottom Sheet
  void _showAddPhaseBottomSheet(BuildContext context, double screenWidth, double screenHeight) {
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Container(
          ...
          child: SingleChildScrollView(
            ...
            child: _buildAddPhaseForm(context, screenWidth, screenHeight),
          ),
        ),
      ),
    );
  ...
  // Method to build the Add Phase form
  Widget _buildAddPhaseForm(BuildContext context, double screenWidth, double screenHeight) {
    return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => DropdownButtonFormField<String>(
              ...
              onChanged: addPhaseController.setScoringType,
              decoration: InputDecoration(
                labelText: "scoring_type".tr,
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                ),
                prefixIcon: Icon(Icons.score),
              ),
              items: addPhaseController.scoringTypeOptions
            ...
            Obx(() => DropdownButtonFormField<String>(
              ...
              onChanged: addPhaseController.setDifficulty,
              decoration: InputDecoration(
              ...
              items: addPhaseController.difficultyOptions
            ...
            Obx(() => Wrap(
              spacing: 8,
              children: addPhaseController.challengeTypeOptions
                  .map((type) => FilterChip(
                label: Text(type),
                selected: addPhaseController.challengeTypes.contains(type),
                onSelected: (selected) {
                  addPhaseController.toggleChallengeType(type);
                },
                selectedColor: AppColors.selectLangugaeColor,
              ))
                  .toList(),
            )),
            SizedBox(height: 16),
            ...
            Obx(() => SizedBox(
              ...
              child: ElevatedButton(
                onPressed: addPhaseController.isLoading.value
                    ? null
                    : () async {
                ...
                child: addPhaseController.isLoading.value
