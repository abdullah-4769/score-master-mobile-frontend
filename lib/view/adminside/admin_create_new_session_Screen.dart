                            ...
                            text: TextSpan(
                              style: TextStyle(
                                fontSize: ResponsiveFont.getFontSizeCustom(
                                  defaultSize: 22 * scaleFactor,
                                  smallSize: 17 * scaleFactor,
                                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() => GameSelectUseableContainer(
                      fontSize: ResponsiveFont.getFontSizeCustom(
                        defaultSize: 13 * scaleFactor,
                        smallSize: 9 * scaleFactor,
                      ),
