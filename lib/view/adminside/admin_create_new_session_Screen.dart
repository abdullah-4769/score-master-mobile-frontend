...
class AdminCreateNewSessionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double baseHeight = 812.0;  double baseWidth = 375.0; 
              ...
              children: [
                ...
                ,
                  ...
                  text2: "creative_problem_workshop".tr,
                   ...
                   CountContainerRow(scaleFactor: scaleFactor),   SizedBox(height: 30 * scaleFactor),
                      BoldText(
                ...
                MainText(text: "enable_ai_scoring".tr, fontSize:ResponsiveFont.getFontSizeCustom(
                  defaultSize: 11*widthScaleFactor,smallSize: 9*widthScaleFactor,
                      ...
                      SizedBox(height: 30 * scaleFactor),
                   AdditionalSettingColumn(scaleFactor: scaleFactor, widthScaleFactor: widthScaleFactor),
